...
The model tier you select affects the quality, depth, and latency of Assistant's responses. Unity AI Assistant provides the following model tiers you can choose from:
