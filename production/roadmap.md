...
- [ ] Configurar Pixel Perfect Camera. Pacote adicionado ao `manifest.json` (versao nao confirmada, ver nota abaixo).
- [ ] Configurar Cinemachine. Pacote adicionado ao `manifest.json` (versao nao confirmada, ver nota abaixo).
