# Premissa Narrativa e Linha do Tempo

## Linha do tempo da história

1. **Presente (ponto de partida):** Terra degradada — escassez de água, comida e recursos. Uma empresa farmacêutica/tech divulga relatório: vida inviável em 10 anos.
...
8. **Segunda máquina:** ao ser usada pela primeira vez, lança o protagonista no início da timeline alterada — o momento exato em que o vilão começou a mudar a história.
9. **Estrutura de progressão:** a partir daí, o protagonista coleta **fragmentos** (recompensa por completar cada época/fase) para melhorar sua máquina do tempo e acessar novas eras.

## A Anomalia (regra central do mundo)

O vilão pode viajar para qualquer época usando a máquina principal. Um efeito colateral dessa manipulação temporal — a **anomalia** — adapta automaticamente roupas, ferramentas e armas de quem viaja no tempo ao padrão daquele período histórico (ex: era medieval → arco, espada, escudo, vestimentas de época).

Essa mesma anomalia:
- Afeta o protagonista, explicando por que suas roupas e armas mudam conforme ele avança pelas eras.
- É a origem da condição da terceira personagem (Naiara) — ver `personagens/naiara.md`. No momento em que o vilão rompeu a timeline pela primeira vez, o paradoxo gerado marcou a linhagem dela como um contrapeso natural da realidade.
